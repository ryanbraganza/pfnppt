 ...
 *
 ...
 return stride.helper('/pf-adf-service/convert?from=markdown&to=adf', 'POST', opts);
 ...
 *  @description
 *  Takes a Atlassian Document as a parameter, calls ADF rendering service and returns plain/text.
 *
 ```
 opts.headers = {
		accept: 'text/plain',
