...
function addHelpMessage(doc) {
  ...
  list.textItem('Placeholder');
  list.textItem(
    'Click on the "..." menu next to any message and then "Send to dialog" or "Send to service"'
  );
...
module.exports.helpMenu = () => {
  ...
  doc.paragraph().text("Here's what you can do.");
...
module.exports.welcomeMessage = appUserId => {
  ...
  doc
    .paragraph()
    .text(
      `I'm the ${app_name}! Thanks for adding me.  Ready to take the tour? PS: to see this help menu again, just mention `
    )
    .mention(appUserId)
    .emoji(':smile:');
