...
$(document).ready(function() {
  ...
  $('#listenToMessages').click(function() {
    AP.action.openTarget({
      target: {
  ...
  $('#textMarkdownFormatMessage').click(function(event) {
    init(event);
    AP.auth.withToken(function(err, token) {
      $.ajax({
        type: 'POST',
        url: '/messages/textMarkdownFormat',
        headers: { Authorization: 'Bearer ' + token },
        dataType: 'json',
        success: function(data) {
          success(event, data);
  ...
  $('#inlineMessageAction').click(function(event) {
    ...
    AP.auth.withToken(function(err, token) {
      $.ajax({
        type: 'POST',
        url: '/actions/inlineMessageAction',
        headers: { Authorization: 'Bearer ' + token },
        dataType: 'json',
        success: function(data) {
          success(event, data);
  ...
  $('#inlineMessageSelect').click(function(event) {
    ...
    AP.auth.withToken(function(err, token) {
      $.ajax({
        type: 'POST',
        url: '/actions/inlineMessageSelect',
        headers: { Authorization: 'Bearer ' + token },
        dataType: 'json',
        success: function(data) {
          success(event, data);
